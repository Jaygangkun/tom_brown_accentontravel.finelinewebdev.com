...
class FliFieldGlyphicon extends FliField
{
	...
	public function output($show = "both") {
		...
		$this->value = "<span class='glyphicons glyphicons-$this->value'></span>";
