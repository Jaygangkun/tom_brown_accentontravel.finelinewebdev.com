...
<table class="table table-striped">
	...
	<thead>
		<th width="1%" class="small center text-center hidden-phone"><input type="checkbox" name="checkall-toggle" value="" onclick="Joomla.checkAll(this);"/></th>
	...
	<tbody>
		...
		<tr class="row<?php echo $i % 2; ?>">
			...
			<td class="center text-center small">
				<span id="status<?php echo $item->id; ?>" class="badge badge-<?php echo $item->status == 200 ? 'success' : 'important'; ?>">
