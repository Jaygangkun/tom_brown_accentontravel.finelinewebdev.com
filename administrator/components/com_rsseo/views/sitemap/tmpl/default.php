			...
			<table class="table table-bordered">
				...
				<tr id="sitemap">
					<td>
						...
						<span id="sitemapspan">
							<?php echo JText::sprintf('COM_RSSEO_CREATE_SITEMAP_ROR_XML','<span class="badge badge-info">sitemap.xml</span>','<a href="javascript:void(0)" class="btn btn-primary btn-sm" onclick="RSSeo.createFile(\'sitemap\');">'.JText::_('COM_RSSEO_GLOBAL_HERE').'</a>'); ?>
						</span>
					</td>
				</tr>
				<?php } ?>
				...
				<tr id="ror">
					<td>
						...
						<span id="rorspan">
							<?php echo JText::sprintf('COM_RSSEO_CREATE_SITEMAP_ROR_XML','<span class="badge badge-info">ror.xml</span>','<a href="javascript:void(0)" class="btn btn-primary btn-sm" onclick="RSSeo.createFile(\'ror\');">'.JText::_('COM_RSSEO_GLOBAL_HERE').'</a>'); ?>
						</span>
					</td>
				</tr>
				<?php } ?>
