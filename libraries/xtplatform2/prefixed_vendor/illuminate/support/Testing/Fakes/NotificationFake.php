<?php
/* This file has been prefixed by <PHP-Prefixer> for "XT Tailwind CSS" on 2019-08-30 11:38:37 */
...
class NotificationFake implements NotificationFactory
{
    ...
    public function sent($notifiable, $notification, $callback = null)
    {
        ...
        $notifications = XTP_collect($this->notificationsFor($notifiable, $notification));
