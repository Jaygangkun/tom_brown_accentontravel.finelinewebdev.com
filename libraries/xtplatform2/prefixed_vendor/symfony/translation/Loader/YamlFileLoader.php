...
use XTP_BUILD\Symfony\Component\Yaml\Exception\ParseException;
use XTP_BUILD\Symfony\Component\Yaml\Parser as YamlParser;
...
class YamlFileLoader extends FileLoader
{
    ...
    protected function loadResource($resource)
    {
        if (null === $this->yamlParser) {
            if (!class_exists('XTP_BUILD\Symfony\Component\Yaml\Parser')) {
