<?php /* This file has been prefixed by <PHP-Prefixer> for "XT Platform" on 2019-09-01 09:25:57 */
...
use XTP_BUILD\Carbon\Exceptions\NotAPeriodException;
use XTP_BUILD\Carbon\Traits\Mixin;
use XTP_BUILD\Carbon\Traits\Options;
use Closure;
use Countable;
use DateInterval;
use DatePeriod;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     * @var string
     */
    const RECURRENCES_FILTER = 'XTP_BUILD\Carbon\CarbonPeriod::filterRecurrences';
    const END_DATE_FILTER = 'XTP_BUILD\Carbon\CarbonPeriod::filterEndDate';
     ...
     * @var string
     */
    const END_ITERATION = 'XTP_BUILD\Carbon\CarbonPeriod::endIteration';
