	...
	static function getNewMenuView($type) {
		...
		switch ($type) {
			case 'patTemplate':
				...
				break;
			case 'fluid':
				include_once(constant('EXTENDED_MENU_HOME').'/view/fluid.menuview.class.php');
				$view = new FluidExtendedMenuView();
				break;
			case 'fluidnocollapse':
				include_once(constant('EXTENDED_MENU_HOME').'/view/fluidnocollapse.menuview.class.php');
				$view = new FluidnocollapseExtendedMenuView();
				break;
			case 'mobile_select_tree':
				include_once(constant('EXTENDED_MENU_HOME').'/view/mobileselectlist.menuview.class.php');
				$view = new MobileSelectListExtendedMenuView();
				break;
			case 'list_flat':
				$maxDepth = 0;
			case 'list_tree':
