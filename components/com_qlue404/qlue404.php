...
require_once JPATH_ROOT.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_qlue404'.DIRECTORY_SEPARATOR.'controller.php';

// Create our new controller class
$controller = new Qlue404Controller(array('base_path' => JPATH_ROOT.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_qlue404'));
