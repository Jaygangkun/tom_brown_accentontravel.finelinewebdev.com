...
function modChrome_FLuid($module, &$params, &$attribs)
{
	...
	if(empty($moduleClass) && strpos($params->get('moduleclass_sfx'), "col-") === false) {
		$moduleClass = " col-sm-12";
	}
...
function modChrome_FLuidFull($module, &$params, &$attribs)
{
	$moduleTag      = $params->get('module_tag', 'div');
	$headerTag      = htmlspecialchars($params->get('header_tag', 'h3'));
	$bootstrapSize  = (int) $params->get('bootstrap_size', 0);
